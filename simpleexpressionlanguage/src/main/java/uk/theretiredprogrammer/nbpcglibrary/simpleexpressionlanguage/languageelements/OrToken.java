...
/**
 * The Logical OR Operator (|). OR two boolean values.
 * 
...
public class OrToken extends OperatorToken {
    ...
    public ParseTree getParseTree(ParseTree lower, ParseTree upper) {
        return new OrOperation(lower, upper);
    }

    private class OrOperation extends ParseTreeBooleanResult {

        public final ParseTree left;
        public final ParseTree right;

        public OrOperation(ParseTree left, ParseTree right) {
            this.left = left;
            this.right = right;
        }
