...
/**
 * The LessThanOrEquals Operator (&lt;=). Compare two integer values.
 * 
 * @author Richard Linsdale (richard at theretiredprogrammer.uk)
 */
public class LessThanEqualsToken extends OperatorToken {
     ...
     */
    public LessThanEqualsToken(int index) {
        super(index);
    }
    ...
    public ParseTree getParseTree(ParseTree lower, ParseTree upper) {
        return new LessThanEqualsOperation(lower, upper);
    }

    private class LessThanEqualsOperation extends ParseTreeBooleanResult {

        public final ParseTree left;
        public final ParseTree right;

        public LessThanEqualsOperation(ParseTree left, ParseTree right) {
            this.left = left;
            this.right = right;
        }
