...
/**
 * The Division Operator (/). Divide two integers generating an integer result.
 *
...
public class DivToken extends OperatorToken {
    ...
    public ParseTree getParseTree(ParseTree lower, ParseTree upper) {
        return new DivOperation(lower, upper);
    }

    private class DivOperation extends ParseTreeIntegerResult {

        public final ParseTree left;
        public final ParseTree right;

        public DivOperation(ParseTree left, ParseTree right) {
            this.left = left;
            this.right = right;
        }
