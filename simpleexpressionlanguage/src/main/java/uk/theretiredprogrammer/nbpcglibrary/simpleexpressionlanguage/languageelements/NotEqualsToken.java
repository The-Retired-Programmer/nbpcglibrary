...
/**
 * The NotEquals Operator (!==). Compares two strings for inequality.
 * 
...
public class NotEqualsToken extends OperatorToken {
     ...
     */
    public NotEqualsToken(int index) {
        super(index);
    }
    ...
    public ParseTree getParseTree(ParseTree lower, ParseTree upper) {
        return new NotEqualsOperation(lower, upper);
    }

    private class NotEqualsOperation extends ParseTreeBooleanResult {

        public final ParseTree left;
        public final ParseTree right;

        public NotEqualsOperation(ParseTree left, ParseTree right) {
            this.left = left;
            this.right = right;
        }
        ...
        public boolean getResult(Map<String, String> parameters) {
            return !ParseTreeStringResult.evaluate(left, parameters).equals(ParseTreeStringResult.evaluate(right, parameters));
        }
    }
}
