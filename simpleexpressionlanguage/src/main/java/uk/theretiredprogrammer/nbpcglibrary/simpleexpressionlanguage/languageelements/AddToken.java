...
/**
 * The Addition Operator (+).  Add two integer values.
 * 
...
public class AddToken extends OperatorToken {
    ...
    public ParseTree getParseTree(ParseTree lower, ParseTree upper) {
        return new AddOperation(lower, upper);
    }

    private class AddOperation extends ParseTreeIntegerResult {

        public final ParseTree left;
        public final ParseTree right;

        public AddOperation(ParseTree left, ParseTree right) {
            this.left = left;
            this.right = right;
        }
