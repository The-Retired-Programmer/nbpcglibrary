...
/**
 * The GreaterThan Operator (&gt;). Compare two integer values.
 * 
...
public class GreaterThanToken extends OperatorToken {
     ...
     */
    public GreaterThanToken(int index) {
        super(index);
    }
    ...
    public ParseTree getParseTree(ParseTree lower, ParseTree upper) {
        return new GreaterThanOperation(lower, upper);
    }

    private class GreaterThanOperation extends ParseTreeBooleanResult {

        public final ParseTree left;
        public final ParseTree right;

        public GreaterThanOperation(ParseTree left, ParseTree right) {
            this.left = left;
            this.right = right;
        }
