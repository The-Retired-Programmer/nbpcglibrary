...
/**
 * The NotEquals Operator (!=). Compares two strings for inequality ignoring case.
 * 
 * @author Richard Linsdale (richard at theretiredprogrammer.uk)
 */
public class NotEqualsIgnoreCaseToken extends OperatorToken {
     ...
     */
    public NotEqualsIgnoreCaseToken(int index) {
        super(index);
    }
    ...
    public ParseTree getParseTree(ParseTree lower, ParseTree upper) {
        return new NotEqualsIgnoreCaseOperation(lower, upper);
    }

    private class NotEqualsIgnoreCaseOperation extends ParseTreeBooleanResult {

        public final ParseTree left;
        public final ParseTree right;

        public NotEqualsIgnoreCaseOperation(ParseTree left, ParseTree right) {
            this.left = left;
            this.right = right;
        }
