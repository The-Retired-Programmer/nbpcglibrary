...
/**
 * The Subtraction Operator (-).  Subtract two integer values.
 * 
...
public class SubToken extends OperatorToken {
    ...
    public ParseTree getParseTree(ParseTree lower, ParseTree upper) {
        return new SubOperation(lower, upper);
    }

    private class SubOperation extends ParseTreeIntegerResult {

        public final ParseTree left;
        public final ParseTree right;

        public SubOperation(ParseTree left, ParseTree right) {
            this.left = left;
            this.right = right;
        }
