...
/**
 * The Remainder Operator (%). Calculates the remainder (mod) of two integer values.
 * 
...
public class ModToken extends OperatorToken {
    ...
    public ParseTree getParseTree(ParseTree lower, ParseTree upper) {
        return new ModOperation(lower, upper);
    }
    ...
    private class ModOperation extends ParseTreeIntegerResult {
        ...
        public ModOperation(ParseTree left, ParseTree right) {
            this.left = left;
            this.right = right;
        }
