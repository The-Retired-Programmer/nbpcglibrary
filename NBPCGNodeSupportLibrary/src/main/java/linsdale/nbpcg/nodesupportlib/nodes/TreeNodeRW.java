...
import linsdale.nbpcg.datasupportlib.entity.EntityStateChangeListenerParams;
import linsdale.nbpcg.datasupportlib.entity.FieldChangeListenerParams;
import linsdale.nbpcg.nodesupportlib.SaveHandler;
...
public abstract class TreeNodeRW<E extends EntityRW> extends TreeNodeRO<E> {
    ...
    public final void destroy() throws IOException {
        Log.get("linsdale.nbpcg.nodesupportlib").finer("TreeNodeRW:destroy()");
        _deleteRemove();
    }

    @Override
    public final Transferable clipboardCut() throws IOException {
        Log.get("linsdale.nbpcg.nodesupportlib").finer("TreeNodeRW:clipboardCut()");
    ...
    public final Transferable clipboardCopy() throws IOException {
        Log.get("linsdale.nbpcg.nodesupportlib").finer("TreeNodeRW:clipboardCopy()");
    ...
    private class ExTransfer extends ExTransferable.Single {
        ...
        @Override
        protected E getData() {
            Log.get("linsdale.nbpcg.nodesupportlib").finer("TreeNodeRW$ExTransfer:getData()");
            return getEntity();
        }
    }
