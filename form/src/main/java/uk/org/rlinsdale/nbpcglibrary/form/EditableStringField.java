...
public abstract class EditableStringField extends EditableField<String> {
     ...
     * @param additionalfield additionalfield optional additional field (set to
     * null if not required)
     */
    public EditableStringField(FieldBackingObject<String> backingObject, String label, JComponent field, JComponent additionalfield) {
